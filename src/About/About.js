      ...
      <div className="container">
        ...
        <div className="text">
          ...
          <p>
            ...
            sem. Nam pulvinar elit pulvinar imperdiet bibendum. Integer orci ex,
            ...
            dui, eget tempus turpis commodo.
          </p>
          <p>
            {" "}
            Pellentesque habitant morbi tristique senectus et netus et malesuada
            fames ac turpis egestas. Mauris interdum elit est, non lacinia justo
            blandit eget. Etiam tincidunt vehicula odio convallis ornare. Duis
            sollicitudin est vitae congue congue. Integer tempus volutpat
            turpis, vitae tristique felis. Ut dapibus orci id dapibus pulvinar.
            Mauris tristique quis turpis id maximus. Pellentesque mi nisi,
            finibus quis fringilla in, dapibus vel augue.
          </p>
        </div>
      </div>
    </>
